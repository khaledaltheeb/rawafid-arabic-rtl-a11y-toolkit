...
const schemaFiles = [
  ...
  'schemas/enterprise-evaluation.schema.json',
];
...
const bindings = [
  ...
  ['enterprise/evaluation-plan.json', 'schemas/enterprise-evaluation.schema.json', ['schemaVersion', 'project', 'principles', 'profiles']],
];
